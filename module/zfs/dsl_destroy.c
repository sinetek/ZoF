...
dsl_destroy_snapshot_sync_impl(dsl_dataset_t *ds, boolean_t defer, dmu_tx_t *tx)
{
	...
	if (defer &&
		...
		spa_history_log_internal_ds_quiet(ds, "defer_destroy", tx);
		return;
	}
	...
	spa_history_log_internal_ds_quiet(ds, "destroy", tx);
...
dsl_destroy_head_begin_sync(void *arg, dmu_tx_t *tx)
{
	...
	spa_history_log_internal_ds_quiet(ds, "destroy begin", tx);
	dsl_dataset_rele(ds, FTAG);
}
