...
if platform.system() == "FreeBSD":
    known_freebsd = {
        ...
        'cli_root/zfs_sysfs/zpool_get_unsupported': ['SKIP', na_reason_freebsd],
        'cli_root/zfs_sysfs/zpool_set_unsupported': ['SKIP', na_reason_freebsd],
        ...
        'cli_root/zpool_reopen/zpool_reopen_003_pos': ['SKIP', na_reason_freebsd],
        ...
        'features/large_dnode/large_dnode_002': ['SKIP', na_reason_freebsd],
        'features/large_dnode/large_dnode_006': ['SKIP', na_reason_freebsd],
        'features/large_dnode/large_dnode_008': ['SKIP', na_reason_freebsd],
